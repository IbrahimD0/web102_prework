...
const backers = GAMES_JSON.reduce((total, game) => total + game.backers, 0);
...
const pledged = GAMES_JSON.reduce((total, game) => total + game.pledged, 0);
...
unfundedGamesInfo.classList.add('center');
